...
public class FriendController {
    ...
    public ResponseEntity<Void> sendRequest(HttpSession session, @PathVariable String handle) {
    ...
    public ResponseEntity<Void> acceptRequest(HttpSession session, @PathVariable String handle) {
    ...
    public ResponseEntity<Void> removeFriend(HttpSession session, @PathVariable String handle) {
